...
import (
	...
	"github.com/nholuongut/cert-manager/pkg/issuer/acme/http/solver"
...
func NewACMESolverCommand(_ context.Context) *cobra.Command {
	...
	// TODO(@inteon): use flags to configure the log configuration (https://github.com/nholuongut/cert-manager/issues/6021)
