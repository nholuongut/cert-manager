...
import (
	...
	configscheme "github.com/nholuongut/cert-manager/internal/apis/config/controller/scheme"
	defaults "github.com/nholuongut/cert-manager/internal/apis/config/controller/v1alpha1"
	"github.com/nholuongut/cert-manager/internal/controller/feature"
	configv1alpha1 "github.com/nholuongut/cert-manager/pkg/apis/config/controller/v1alpha1"
...
func AddConfigFlags(fs *pflag.FlagSet, c *config.ControllerConfiguration) {
	...
	// https://github.com/nholuongut/cert-manager/blob/f1d7c432763100c3fb6eb6a1654d29060b479b3c/pkg/apis/acme/v1/types_issuer.go#L270
