...
import (
	...
	"github.com/nholuongut/cert-manager/controller-binary/app/options"
	config "github.com/nholuongut/cert-manager/internal/apis/config/controller"
	"github.com/nholuongut/cert-manager/internal/apis/config/controller/validation"
	controllerconfigfile "github.com/nholuongut/cert-manager/pkg/controller/configfile"
	logf "github.com/nholuongut/cert-manager/pkg/logs"
	"github.com/nholuongut/cert-manager/pkg/util"
	"github.com/nholuongut/cert-manager/pkg/util/configfile"
	utilfeature "github.com/nholuongut/cert-manager/pkg/util/feature"

	_ "github.com/nholuongut/cert-manager/pkg/controller/acmechallenges"
	_ "github.com/nholuongut/cert-manager/pkg/controller/acmeorders"
	_ "github.com/nholuongut/cert-manager/pkg/controller/certificate-shim/gateways"
	_ "github.com/nholuongut/cert-manager/pkg/controller/certificate-shim/ingresses"
	_ "github.com/nholuongut/cert-manager/pkg/controller/certificates/trigger"
	_ "github.com/nholuongut/cert-manager/pkg/controller/clusterissuers"
	_ "github.com/nholuongut/cert-manager/pkg/controller/issuers"
	_ "github.com/nholuongut/cert-manager/pkg/issuer/acme"
	_ "github.com/nholuongut/cert-manager/pkg/issuer/ca"
	_ "github.com/nholuongut/cert-manager/pkg/issuer/selfsigned"
	_ "github.com/nholuongut/cert-manager/pkg/issuer/vault"
	_ "github.com/nholuongut/cert-manager/pkg/issuer/venafi"
)
