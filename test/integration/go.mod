module github.com/nholuongut/cert-manager/integration-tests
...
replace github.com/nholuongut/cert-manager => ../../

replace github.com/nholuongut/cert-manager/webhook-binary => ../../cmd/webhook/

require (
	github.com/nholuongut/cert-manager v0.0.0-00010101000000-000000000000
