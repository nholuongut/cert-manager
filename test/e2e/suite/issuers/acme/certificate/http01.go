...
import (
	...
	"github.com/nholuongut/cert-manager/e2e-tests/framework/log"
	"github.com/nholuongut/cert-manager/e2e-tests/util"
...
var _ = framework.CertManagerDescribe("ACME Certificate (HTTP01)", func() {
	...
	// https://github.com/nholuongut/cert-manager/issues/1571
