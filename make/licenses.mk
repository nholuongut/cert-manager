...
$(bin_dir)/scratch/license-footnote.yaml: | $(bin_dir)/scratch
	@echo -e "# To view licenses for cert-manager dependencies, see the LICENSES file in the\n# cert-manager repo: https://github.com/nholuongut/cert-manager/blob/$(GITCOMMIT)/LICENSES" > $@
...
# github/nholuongut/cert-manager module and all the dependencies of the
# github/nholuongut/cert-manager module.
#
...
# https://github.com/nholuongut/cert-manager/pull/5935
