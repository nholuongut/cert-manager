...
repo_name := github.com/nholuongut/cert-manager
...
## @category Build
GOLDFLAGS := -w -s \
	-X github.com/nholuongut/cert-manager/pkg/util.AppVersion=$(VERSION) \
    -X github.com/nholuongut/cert-manager/pkg/util.AppGitCommit=$(GITCOMMIT)
