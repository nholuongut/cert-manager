...
- We call `github.com/nholuongut/cert-manager` the **core module**
...
- Core go.mod dependencies are reduced
  - All importers of `github.com/nholuongut/cert-manager` have fewer transitive dependencies
...
only `cmctl`). We can see the dependency in [go.mod](https://github.com/nholuongut/cert-manager/blob/f54dd1dc98900607e1db7bd4ac2512f0bfe39301/go.mod#L41).
...
Currently cert-manager has one module name: `github.com/nholuongut/cert-manager`. This import path is widely used and
...
To be clear: using replace directives like this will break anyone who tries to import the `github.com/nholuongut/cert-manager/controller-binary`
module or anyone who was previously importing `github.com/nholuongut/cert-manager/cmd/controller` before this proposal.
...
There are [known external importers](https://pkg.go.dev/github.com/nholuongut/cert-manager@v1.11.0/test/unit/gen?tab=importedby)
