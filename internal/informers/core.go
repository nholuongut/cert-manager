...
const pleaseOpenIssue = "Please report this by opening an issue with this error and cert-manager controller logs and stack trace https://github.com/nholuongut/cert-manager/issues/new/choose"
