...
import (
	...
	fakeregistry "github.com/nholuongut/cert-manager/pkg/acme/accounts/test"
	acmecl "github.com/nholuongut/cert-manager/pkg/acme/client"
	...
	controllertest "github.com/nholuongut/cert-manager/pkg/controller/test"
	"github.com/nholuongut/cert-manager/pkg/util/errors"
	"github.com/nholuongut/cert-manager/pkg/util/pki"
	"github.com/nholuongut/cert-manager/test/unit/coreclients"
...
func TestAcme_Setup(t *testing.T) {
	var (
		...
		// cert-manager only accepts double-encoded values, see https://github.com/nholuongut/cert-manager/pull/3877#discussion_r610717791 .
