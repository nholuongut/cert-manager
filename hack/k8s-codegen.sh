...
module_name="github.com/nholuongut/cert-manager"
...
gen-openapi-acme() {
  ...
  "$openapigen" \
    ...
    --output-pkg "github.com/nholuongut/cert-manager/pkg/acme/webhook/openapi" \
		--output-file zz_generated.openapi.go \
    "k8s.io/apimachinery/pkg/version" \
    "k8s.io/apimachinery/pkg/runtime" \
    "k8s.io/apimachinery/pkg/apis/meta/v1" \
    "k8s.io/apiextensions-apiserver/pkg/apis/apiextensions/v1" \
    "github.com/nholuongut/cert-manager/pkg/acme/webhook/apis/acme/v1alpha1"
}
...
gen-defaulters() {
  ...
  DEFAULT_EXTRA_PEER_PKGS=(
    github.com/nholuongut/cert-manager/internal/apis/meta \
    github.com/nholuongut/cert-manager/internal/apis/meta/v1 \
    github.com/nholuongut/cert-manager/internal/apis/config/shared \
    github.com/nholuongut/cert-manager/internal/apis/config/shared/v1alpha1 \
    github.com/nholuongut/cert-manager/pkg/apis/meta/v1 \
    github.com/nholuongut/cert-manager/pkg/apis/config/shared/v1alpha1 \
  )
